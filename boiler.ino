...
// Absolute, Gauge
//const int16_t M32ZeroCounts PROGMEM = M32MinScaleCounts;
...
//#define MQTTPREFIX "" // define the prefix of the mqtt messages, example the house name
...
// call it as   resetFunc();  //call reset
...
byte initializeEthernet() {
  ...
  if (Ethernet.begin(pgm_read_word_near(mac)) == 0) {
